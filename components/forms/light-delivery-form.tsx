    ...
    <form onSubmit={handleSubmit} className="mx-auto max-w-3xl space-y-6 p-4 pb-12 lg:p-8 lg:pb-16">
      ...
      <Card>
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl text-foreground">Light Delivery Vehicle Daily Checklist</CardTitle>
          <CardDescription>
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            <Label htmlFor="vehicleRegistration" className="text-foreground">Vehicle Registration <span className="text-destructive">*</span></Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="driversLicense" className="text-foreground">{"Driver's License Available (Exp. Date)"}</Label>
            <Input
              id="driversLicense"
              type="date"
